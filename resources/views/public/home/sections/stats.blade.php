    ...
    <div class="section-container py-8 sm:py-10">
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            ...
            <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-emerald-200 hover:shadow-lg dark:border-white/10 dark:bg-white/5 dark:hover:border-emerald-400/30">
                ...
                <p x-ref="careers" class="mt-4 text-3xl font-bold text-navy-900 dark:text-white sm:text-4xl">0</p>
                <p class="mt-1.5 text-sm font-medium text-slate-500 dark:text-slate-400">Career Opportunities</p>
            ...
            <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-sky-200 hover:shadow-lg dark:border-white/10 dark:bg-white/5 dark:hover:border-sky-400/30">
                ...
                <p x-ref="carpooling" class="mt-4 text-3xl font-bold text-navy-900 dark:text-white sm:text-4xl">0</p>
                <p class="mt-1.5 text-sm font-medium text-slate-500 dark:text-slate-400">Carpooling Services</p>
            ...
            <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-rose-200 hover:shadow-lg dark:border-white/10 dark:bg-white/5 dark:hover:border-rose-400/30">
                <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-rose-50 text-rose-700 transition-transform duration-300 group-hover:scale-110 dark:bg-rose-400/10 dark:text-rose-300">
                    <x-icon name="heart" class="h-6 w-6" />
                </div>
                <p x-ref="matrimony" class="mt-4 text-3xl font-bold text-navy-900 dark:text-white sm:text-4xl">0</p>
                <p class="mt-1.5 text-sm font-medium text-slate-500 dark:text-slate-400">Brides &amp; Grooms</p>
                <span class="mx-auto mt-3 block h-0.5 w-8 rounded-full bg-rose-200 transition-all duration-300 group-hover:w-12 dark:bg-rose-500/40"></span>
            </div>

            <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-purple-200 hover:shadow-lg dark:border-white/10 dark:bg-white/5 dark:hover:border-purple-400/30">
                <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-purple-50 text-purple-700 transition-transform duration-300 group-hover:scale-110 dark:bg-purple-400/10 dark:text-purple-300">
                    <x-icon name="book-open" class="h-6 w-6" />
                </div>
                <p x-ref="books" class="mt-4 text-3xl font-bold text-navy-900 dark:text-white sm:text-4xl">0</p>
                <p class="mt-1.5 text-sm font-medium text-slate-500 dark:text-slate-400">Available Books</p>
                <span class="mx-auto mt-3 block h-0.5 w-8 rounded-full bg-purple-200 transition-all duration-300 group-hover:w-12 dark:bg-purple-500/40"></span>
            </div>
        </div>
    </div>
</section>
