<x-layouts::admin :title="'Edit Job'">
    ...
    <form method="POST" action="{{ route('admin.jobs.update', $job) }}" class="card card-body mt-6 space-y-5">
        ...
        <x-input label="Tags" name="tags" :value="old('tags', $job->tags)" placeholder="e.g. remote, entry-level, marketing" hint="Optional keywords to help alumni find this job in search. Separate multiple tags with commas." />
