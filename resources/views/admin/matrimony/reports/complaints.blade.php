<x-layouts::admin :title="'Matrimony Complaints'">
    <x-breadcrumb :items="[['label' => 'Matrimony'], ['label' => 'Reports', 'url' => route('admin.matrimony.reports.index')], ['label' => 'Complaints']]" class="mb-4" />
        ...
        <div class="mt-6 space-y-4">
            @foreach ($complaints as $complaint)
                @php
                    ...
                    $targetLabel = $target instanceof \App\Models\MatrimonyProfile
                ...
                <div class="card card-body">
                    ...
                    @if ($complaint->status === 'pending')
                        <div class="mt-3 flex gap-2">
                            <form method="POST" action="{{ route('admin.matrimony.reports.complaints.resolve', $complaint) }}">
                                @csrf
