...
class CateringHomemadeOrder extends Model
{
    use HasFactory;
    ...
    protected $fillable = [
        'catering_homemade_listing_id', 'buyer_id', 'seller_id', 'quantity', 'status',
        'handled_by', 'final_price', 'commission_percentage_snapshot', 'commission_amount', 'admin_notes',
    ];
    ...
    {
        return $query->whereIn('status', [self::STATUS_PENDING, self::STATUS_ONGOING]);
    }
